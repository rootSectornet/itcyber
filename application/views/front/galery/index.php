...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/front/css/colors/color1.css">   
   <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/front/jquery.bsPhotoGallery.css" rel="stylesheet">
    <script src="https://code.jquery.com/jquery-1.10.2.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/front/jquery.bsPhotoGallery.js"></script>
    </script>
    <script>
      ...
      <div class="portfolio-bottom">
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
                  <ul class="row first">
                      <?php foreach ($galery->result() as $gal): ?>
                          <li>
                              <img alt="<?= $gal->caption;?>"  src="<?= $gal->link;?>">
                              <div class="text"><?= $gal->caption;?></div>
                          </li>
                    <?php endforeach ?>
                  </ul>
