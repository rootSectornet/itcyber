                    ...
                    <?php foreach ($jabatan->result() as $row): ?>
                      <tr>
                        ...
                        <td>
                                  ...
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <?php $atributes = array('role' => 'form');
                                          echo form_open('Itcyb3r/anggota/edit_jabatan',$atributes); 
                                      ?>
                                        <div class="modal-body">
                                            <div class="box-body">
                                              <div class="form-group">
                                                <label for="jabatan">Jabatan : </label>
                                                    <input type="text" class="form-control" required name="jabatan" id="jabatan" value="<?= $row->jabatan;?>">
                                              </div>
                                              <input type="hidden" name="id" value="<?= $row->id_jabatan;?>" required>
                                            </div>
                                        </div>
                            ...
                            <a  href="<?php echo base_url(); ?>Itcyb3r/anggota/delete_jabatan/<?= $row->id_jabatan;?>" class="btn btn-danger btn-waves" data-toggle="tooltip" data-placement="top" title="Delete !"  onclick="return ConfirmDialog()"><i class="fa fa-trash fa-fw"></i></a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                </tbody>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <?php echo form_open('Itcyb3r/anggota/tambah_jabatan'); ?>
                <div class="modal-body">
                  <div class="form-group">
                    <label for="jabatan">Jabatan :</label>
                    <input type="text" name="jabatan" id="jabatan" required class="form-control" placeholder="ANGKATAN !">
                  </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
